...
import org.fortune.commons.datacache.conf.LocalConfig;
import org.fortune.commons.datacache.conf.MemCachedConfig;
import org.fortune.commons.datacache.conf.MongoConfig;
import org.fortune.commons.datacache.handler.LoadFromCache;
import org.fortune.commons.datacache.handler.StoreToCache;
import org.fortune.commons.datacache.plugins.local.load.LoadFromLocalMemory;
import org.fortune.commons.datacache.plugins.local.store.StoreToLocalMemory;
import org.fortune.commons.datacache.plugins.mongo.MongoDBOperator;
import org.fortune.commons.datacache.plugins.mongo.load.LoadFromMongo;
import org.fortune.commons.datacache.plugins.mongo.store.StoreToMongo;
import org.fortune.commons.datacache.plugins.memcached.MemCachedOperator;
import org.fortune.commons.datacache.plugins.memcached.load.LoadFromMemCached;
import org.fortune.commons.datacache.plugins.memcached.store.StoreToMemCached;
import org.fortune.commons.datacache.service.LoadCacheDataService;
import org.fortune.commons.datacache.service.StoreCacheDataService;
import org.fortune.commons.datacache.service.impl.LoadCacheDataServiceImpl;
import org.fortune.commons.datacache.service.impl.StoreCacheDataServiceImpl;
