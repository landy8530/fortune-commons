            ...
            if(node instanceof MappingNode) {
                ...
                for(NodeTuple nodeTuple : nodes) {
                    ...
                    if(keyNode instanceof ScalarNode) {
                        ...
                        if("imagesBasePath".equals(key)) {
                            if(valueNode instanceof ScalarNode) {
                                String imagesBasePath = ((ScalarNode) valueNode).getValue();
                                docServerContainer.setImagesBasePath(imagesBasePath);
                            }
                        }

                        if("attachmentBasePath".equals(key)) {
                            if(valueNode instanceof ScalarNode) {
                                String attachmentBasePath = ((ScalarNode) valueNode).getValue();
                                docServerContainer.setAttachmentBasePath(attachmentBasePath);
                            }
                        }
                    }
